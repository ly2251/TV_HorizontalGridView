...
package com.view.shinx.horizontalgv;
 ...
 *
 * <ul>
 *     <li><em>Adapter:</em> A subclass of {@link RecyclerView.Adapter} responsible for providing views
...
public class RecyclerView extends ViewGroup {
     ...
     * returns true from
     * {@link RecyclerView.OnItemTouchListener#onInterceptTouchEvent(RecyclerView, android.view.MotionEvent)} its
     * {@link RecyclerView.OnItemTouchListener#onTouchEvent(RecyclerView, android.view.MotionEvent)} method will be called
     ...
     * PERSISTENT views are moved ({@link RecyclerView.ItemAnimator#animateMove(RecyclerView.ViewHolder, int, int, int, int)})
     * REMOVED views are removed ({@link RecyclerView.ItemAnimator#animateRemove(RecyclerView.ViewHolder)})
     * ADDED views are added ({@link RecyclerView.ItemAnimator#animateAdd(RecyclerView.ViewHolder)})
    ...
    public final class Recycler {
         ...
         *
         * <p>This method should be used by {@link RecyclerView.LayoutManager} implementations to obtain
         * views to represent data from an {@link RecyclerView.Adapter}.</p>
         *
    ...
    public static abstract class LayoutManager {
         ...
         * rules as outlined in {@link #onLayoutChildren(RecyclerView.Recycler, RecyclerView.State)}.
         ...
         * then there will be two calls to {@link #onLayoutChildren(RecyclerView.Recycler, RecyclerView.State)} to
         ...
         * then {@link #onFocusSearchFailed(android.view.View, int, RecyclerView.Recycler, RecyclerView.State)}
     ...
     * views (in {@link RecyclerView.ItemDecoration#onDraw(android.graphics.Canvas, RecyclerView) onDraw()} and after the items
     * (in {@link RecyclerView.ItemDecoration#onDrawOver(android.graphics.Canvas, RecyclerView)}.</p>
     */
     ...
     *
     * @see RecyclerView#setOnScrollListener(RecyclerView.OnScrollListener)
     */
    ...
    public static abstract class SmoothScroller {
         ...
         * @return An {@link RecyclerView.SmoothScroller.Action} to finalize the smooth scrolling
         */
     ...
     * method when each item animation is done ({@link #dispatchRemoveFinished(RecyclerView.ViewHolder)},
     * {@link #dispatchMoveFinished(RecyclerView.ViewHolder)}, or {@link #dispatchAddFinished(RecyclerView.ViewHolder)}).
     *
    ...
    public static abstract class ItemAnimator {
         ...
         * is governed by the return values from {@link #animateAdd(RecyclerView.ViewHolder) animateAdd()},
         * {@link #animateMove(RecyclerView.ViewHolder, int, int, int, int) animateMove()}, and
         * {@link #animateRemove(RecyclerView.ViewHolder) animateRemove()}, which inform the
         ...
         * {@link #animateMove(RecyclerView.ViewHolder, int, int, int, int) animateMove()}, and
         * {@link #animateRemove(RecyclerView.ViewHolder) animateRemove()} come in one by one, then
         ...
         * Also, appropriate dispatch methods (e.g., {@link #dispatchAddFinished(RecyclerView.ViewHolder)}
